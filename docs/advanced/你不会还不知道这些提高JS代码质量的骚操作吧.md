...
这里只是详细讲解了 标识符命名规范 和 代码注释规范，由于篇幅有限，还有很多其它的规范没有些，大家可以可以参考一下[Airbnb JavaScript Style Guide](https://github.com/AlbertYang666/javascript-1)。
...
今天的学习就到这里，你可以使用今天学习的技巧来改善一下你曾经的代码，如果想继续提高，欢迎关注我的微信公众号：AlbertYang，每天学习进步一点点，就是领先的开始。**如果觉得本文对你有帮助的话，欢迎Star,完善！！！**
